...
const Navbar = () => {
  ...
  return (
    <nav className="w-full px-8 py-6 border-b border-white/10 bg-[#0B1221]">
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="md:hidden mt-4 flex flex-col gap-4 px-4 pb-4 text-sm font-medium text-gray-200 border-t border-white/10 pt-4">
