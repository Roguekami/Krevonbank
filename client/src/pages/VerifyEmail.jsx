  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0B1221] flex items-center justify-center p-6">
      <motion.div 
        ...
        className="w-full max-w-md bg-white dark:bg-[#152336] p-8 rounded-2xl border border-gray-200 dark:border-white/10 text-center shadow-2xl"
      >
        {status === 'loading' && (
          <div className="flex flex-col items-center">
            <Loader className="w-16 h-16 text-[#D4AF37] animate-spin mb-6" />
            <h2 className="text-2xl font-serif text-gray-900 dark:text-white mb-2">Verifying</h2>
        ...
        {status === 'error' && (
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-2xl font-serif text-gray-900 dark:text-white mb-2">Verification Failed</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-6">{message}</p>
            <button 
