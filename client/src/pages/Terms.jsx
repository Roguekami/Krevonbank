      ...
      <main className="flex-grow container mx-auto px-6 py-16 md:py-24 max-w-4xl">
        <div className="bg-[#0f172a] rounded-2xl p-8 md:p-12 shadow-2xl border border-gray-800">
          ...
          <div className="space-y-10 text-lg leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">4. Identity Verification (KYC)</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">5. Banking Services</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">6. Transactions and Transfers</h2>
              <p className="mb-4">All transactions processed through Krevon are subject to the following conditions:</p>
              <ul className="space-y-4">
                <li><strong className="text-white">Processing Times:</strong> International wire transfers and account funding requests are processed manually by our operations team. Processing times may vary and are not guaranteed. Krevon is not liable for delays caused by third-party banks, payment networks, or blockchain congestion.</li>
                <li><strong className="text-white">Transaction Limits:</strong> Minimum and maximum transaction limits apply to all transfers and funding requests. These limits may vary based on your account status and are subject to change. Current limits are displayed within the platform at the time of transaction.</li>
                <li><strong className="text-white">Verification and Approval:</strong> All funding requests, whether via cryptocurrency or bank wire, require manual review and approval by a Krevon administrator before your account balance is credited. Submission of a funding request does not guarantee that your balance will be credited.</li>
                <li><strong className="text-white">Fraud Prevention:</strong> We reserve the right to delay, hold, or cancel any transaction that we reasonably suspect to be fraudulent, unauthorised, related to money laundering, or in violation of these Terms or applicable law. We will notify you where legally permitted to do so.</li>
                <li><strong className="text-white">Exchange Rates:</strong> Currency conversions are subject to live exchange rates at the time of processing. Krevon is not responsible for fluctuations in exchange rates between the time of submission and the time of processing.</li>
                <li><strong className="text-white">Irreversibility:</strong> Completed transactions cannot be reversed. If you believe a transaction has been processed in error, contact our support team immediately. Krevon will investigate but cannot guarantee recovery of funds in all cases.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">7. Cryptocurrency Deposits</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">8. Debit Cards</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">15. Third Party Services</h2>
              <p>
            ...
            <section>
              ...
              <ul className="space-y-2">
                <li><strong className="text-white">Email:</strong> <a href="mailto:support@krevon.com" className="text-[#D4AF37] hover:underline">support@krevon.com</a></li>
                <li><strong className="text-white">Legal Enquiries:</strong> <a href="mailto:legal@krevon.com" className="text-[#D4AF37] hover:underline">legal@krevon.com</a></li>
