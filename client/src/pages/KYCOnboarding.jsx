...
const KYCOnboarding = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0B1221] text-gray-900 dark:text-white pt-24 pb-12 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-16 overflow-x-auto pb-4 custom-scrollbar">
          {steps.map((step, idx) => (
            <div key={step} className="flex items-center whitespace-nowrap">
              ...
              {idx < steps.length - 1 && (
                <div className="w-12 md:w-20 lg:w-32 h-[2px] mx-2 bg-white dark:bg-[#152336]"></div>
              )}
            </div>
          ))}
        </div>
        ...
        {currentStep === 4 ? (
          ...
          <motion.div 
            ...
            className="max-w-2xl mx-auto bg-white dark:bg-[#152336] rounded-2xl p-10 border border-white/5 shadow-2xl text-center"
          >
            ...
            <h2 className="text-3xl font-serif text-gray-900 dark:text-white mb-4">Documents Received</h2>
            ...
            <div className="bg-gray-50 dark:bg-[#0B1221] p-6 rounded-xl border border-white/5 text-left mb-8">
              <h3 className="text-gray-900 dark:text-white font-medium mb-2">What happens next?</h3>
            ...
            <button 
              ...
              className="w-full py-4 rounded-xl bg-white/5 text-gray-900 dark:text-white font-bold hover:bg-white/10 transition-colors"
            >
              Return to Homepage
            </button>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-5">
              ...
              <div className="flex items-center gap-4 text-gray-600 dark:text-gray-400 bg-white dark:bg-[#152336]/50 p-4 rounded-lg border border-[#152336]">
            ...
            <div className="lg:col-span-7">
              <div className="bg-white dark:bg-[#152336] rounded-2xl p-8 border border-white/5 shadow-2xl">
                <form onSubmit={handleSubmit} className="space-y-6">
                  
                  {/* Tier 1 Document */}
                  <div className="space-y-3">
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Government Photo ID (Tier 1)</label>
                    <select 
                    ...
                    <div className="border-2 border-dashed border-white/20 rounded-xl p-6 flex items-center justify-between bg-gray-50 dark:bg-[#0B1221]/50 hover:border-[#D4AF37]/50 transition-colors">
                      <div className="flex-1 text-center border-r border-gray-200 dark:border-white/10 pr-6">
                        <UploadCloud className="w-10 h-10 text-[#D4AF37] mx-auto mb-3" />
                        <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">Drag and drop your file here or</p>
                      ...
                      <div className="flex-1 pl-6 flex items-center justify-center">
                        {tier1Preview ? (
                          <div className="text-center">
                            <img src={tier1Preview} alt="Preview" className="h-24 object-cover rounded-md border border-gray-200 dark:border-white/10 mx-auto" />
                            <p className="text-xs text-gray-600 dark:text-gray-400 mt-2 truncate w-32 mx-auto">{tier1File.name}</p>
                          </div>
                        ) : tier1File && tier1File.type === 'application/pdf' ? (
                          <div className="text-center">
                            <FileText className="w-12 h-12 text-gray-600 dark:text-gray-400 mx-auto" />
                            <p className="text-xs text-gray-600 dark:text-gray-400 mt-2 truncate w-32 mx-auto">{tier1File.name}</p>
                          </div>
                        ) : (
                  ...
                  <div className="space-y-3 pt-4 border-t border-gray-200 dark:border-white/10">
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Proof of Address (Tier 2)</label>
                    <select 
                      className="w-full bg-gray-50 dark:bg-[#0B1221] border border-gray-200 dark:border-white/10 rounded-lg px-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:border-[#D4AF37] transition-colors"
                    ...
                    <div className="border-2 border-dashed border-white/20 rounded-xl p-6 flex items-center justify-between bg-gray-50 dark:bg-[#0B1221]/50 hover:border-[#D4AF37]/50 transition-colors">
                      ...
                      <div className="flex-1 pl-6 flex items-center justify-center">
                        {tier2Preview ? (
                          <div className="text-center">
                            <img src={tier2Preview} alt="Preview" className="h-24 object-cover rounded-md border border-gray-200 dark:border-white/10 mx-auto" />
                            <p className="text-xs text-gray-600 dark:text-gray-400 mt-2 truncate w-32 mx-auto">{tier2File.name}</p>
                          </div>
