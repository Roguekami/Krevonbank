          ...
          <div className="space-y-10 text-lg leading-relaxed">
            ...
            <section>
              ...
              <ul className="space-y-4">
                <li><strong className="text-gray-900 dark:text-white">Personal Information:</strong> Your full name, email address, phone number, date of birth, nationality, and physical address collected during registration and account onboarding.</li>
                <li><strong className="text-gray-900 dark:text-white">Identity and Verification Documents:</strong> Government-issued identification documents including passports, national identity cards, and driver's licenses, as well as proof of address documents such as utility bills and bank statements. These are collected as part of our mandatory Know Your Customer (KYC) verification process.</li>
                <li><strong className="text-gray-900 dark:text-white">Financial Information:</strong> Account balances, transaction history, transfer details, funding requests, beneficiary information, and spending activity across all currencies held on your account.</li>
                <li><strong className="text-gray-900 dark:text-white">Device and Usage Data:</strong> IP addresses, browser type and version, operating system, device identifiers, pages visited, time spent on the platform, and access timestamps collected automatically when you use our services.</li>
                <li><strong className="text-gray-900 dark:text-white">Communications Data:</strong> Any messages, support requests, or correspondence you send to us through our platform or official contact channels.</li>
                <li><strong className="text-gray-900 dark:text-white">Cryptocurrency Transaction Data:</strong> Wallet addresses, transaction hashes, and network information submitted when funding your account through cryptocurrency deposits.</li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">3. Identity Verification and KYC</h2>
              <p className="mb-4">
            ...
            <section>
              ...
              <ul className="space-y-4">
                <li><strong className="text-gray-900 dark:text-white">Service Providers:</strong> We work with trusted third-party service providers who help us operate our platform. These include Supabase for secure database hosting, Cloudinary for encrypted document storage, and email delivery services for transactional notifications. All service providers are contractually bound to handle your data securely and confidentially.</li>
                <li><strong className="text-gray-900 dark:text-white">Legal and Regulatory Obligations:</strong> We may disclose your information to government authorities, law enforcement agencies, or financial regulators when required to do so by law, court order, or regulatory directive.</li>
                <li><strong className="text-gray-900 dark:text-white">Fraud Prevention:</strong> We may share information with fraud prevention agencies and financial crime authorities to protect against unauthorised transactions and identity theft.</li>
                <li><strong className="text-gray-900 dark:text-white">Business Transfers:</strong> In the event of a merger, acquisition, or sale of Krevon's assets, your information may be transferred to the acquiring entity, who will be bound by the terms of this Privacy Policy.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">5. International Data Transfers</h2>
              <p className="mb-4">
            ...
            <section>
              ...
              <ul className="space-y-2 mb-4">
                <li><strong className="text-gray-900 dark:text-white">Right to Access:</strong> You have the right to request a copy of the personal information we hold about you.</li>
                <li><strong className="text-gray-900 dark:text-white">Right to Rectification:</strong> You have the right to request correction of any inaccurate or incomplete information we hold about you.</li>
                <li><strong className="text-gray-900 dark:text-white">Right to Erasure:</strong> You have the right to request deletion of your personal data, subject to our legal retention obligations.</li>
                <li><strong className="text-gray-900 dark:text-white">Right to Restriction:</strong> You have the right to request that we restrict the processing of your personal data in certain circumstances.</li>
                <li><strong className="text-gray-900 dark:text-white">Right to Data Portability:</strong> You have the right to receive your personal data in a structured, machine-readable format.</li>
                <li><strong className="text-gray-900 dark:text-white">Right to Object:</strong> You have the right to object to certain types of processing of your personal data.</li>
                <li><strong className="text-gray-900 dark:text-white">Right to Withdraw Consent:</strong> Where processing is based on your consent, you have the right to withdraw that consent at any time.</li>
              </ul>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">9. Cookies and Tracking</h2>
              ...
              <ul className="space-y-2 mb-4">
                <li><strong className="text-gray-900 dark:text-white">Essential Cookies:</strong> Required for the platform to function. These include session authentication cookies that keep you securely logged in.</li>
                <li><strong className="text-gray-900 dark:text-white">Functional Cookies:</strong> Remember your preferences and settings to personalise your experience.</li>
                <li><strong className="text-gray-900 dark:text-white">Analytics Cookies:</strong> Help us understand how users interact with our platform so we can improve performance and usability. No personally identifiable information is included in analytics data.</li>
              </ul>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">11. Account Closure</h2>
              <p>
            ...
            <section>
              ...
              <ul className="space-y-2">
                <li><strong className="text-gray-900 dark:text-white">Email:</strong> <a href="mailto:privacy@krevon.com" className="text-[#D4AF37] hover:underline">privacy@krevon.com</a></li>
